...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/pvlc-med-cards/{id}/async-result": {
            "put": {
                "description": "Обновляет результаты ДЖЕЛ после асинхронного расчета в Django сервисе\nТребует правильный ключ авторизации в поле async_key",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    {
                        "description": "Результаты расчета от Django сервиса",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/ds.AsyncResultUpdateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/pvlc-med-cards/{id}/complete": {
            "put": {
                ...
                "description": "Завершает или отклоняет заявку (только для модераторов)\nПри завершении запускает асинхронный расчет ДЖЕЛ в Django сервисе",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "ds.AsyncResultUpdateRequest": {
            ...
            "properties": {
                "async_calculated": {
                    "description": "AsyncCalculated - флаг что расчет асинхронный",
                    "type": "boolean"
                },
                "async_key": {
                    "description": "AsyncKey - ключ для авторизации (ОБЯЗАТЕЛЬНОЕ ПОЛЕ!)\nDjango должен отправлять тот же ключ что и в константе AsyncServiceKey",
                    "type": "string"
                },
                "calculated_count": {
